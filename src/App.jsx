...
function PlaceholderImage({ label, labelVi, height = 300, style = {} }) {
  ...
  return (
    <div style={{
      width: "100%", height, background: "linear-gradient(135deg, #E8E0D8 0%, #D4C8BD 100%)",
      display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
      border: "2px dashed #C4B5A8", position: "relative", overflow: "hidden", ...style,
    }}>
      <div style={{
        width: 48, height: 48, borderRadius: "50%", border: "2px solid #A0826D",
      ...
      <span style={{
        ...
        color: "#6B5B50", letterSpacing: "0.08em", textTransform: "uppercase", textAlign: "center",
        padding: "0 16px",
      }}>{displayLabel}</span>
      <span style={{
        fontFamily: "'Lora', serif", fontSize: 11, color: "#A0826D",
        fontStyle: "italic", marginTop: 4,
      }}>{lang === "vi" ? "Sẽ thay thế sau" : "To be replaced"}</span>
    </div>
  );
}

/* ─── Flower Data with Unsplash Images ─── */
const FLOWERS = [
  {
    ...
    image: "https://images.unsplash.com/photo-1490750967868-88aa4f44baee?w=400&h=400&fit=crop&crop=center",
    colors: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1536091479766-e933e5e5e3b7?w=400&h=400&fit=crop&crop=center",
    colors: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1582794543139-8ac9cb0f7b11?w=400&h=400&fit=crop&crop=center",
    colors: [
      { en: "White", vi: "Trắng", hex: "#FEFEFA" },
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1520763185298-1b434c919102?w=400&h=400&fit=crop&crop=center",
    colors: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1468327768560-75b778cbb551?w=400&h=400&fit=crop&crop=center",
    colors: [
      { en: "White", vi: "Trắng", hex: "#FEFEFA" },
...
const WEDDING_SERVICES = [
  {
    ...
    description: { en: "We manage every detail on your wedding day so you can be fully present. From vendor coordination to timeline management, we ensure everything flows seamlessly.", vi: "Chúng tôi quản lý mọi chi tiết trong ngày cưới để bạn hoàn toàn tận hưởng. Từ điều phối nhà cung cấp đến quản lý lịch trình, chúng tôi đảm bảo mọi thứ diễn ra suôn sẻ." },
    features: { en: ["Timeline management", "Vendor coordination", "Ceremony & reception oversight", "Emergency kit on hand"], vi: ["Quản lý lịch trình", "Điều phối nhà cung cấp", "Giám sát lễ cưới & tiệc", "Bộ dụng cụ khẩn cấp"] },
    startingAt: { en: "Starting at $1,500", vi: "Từ $1,500" },
  },
  {
    title: { en: "Bridal Florals", vi: "Hoa Cô Dâu" },
    description: { en: "Custom bridal bouquets, bridesmaid arrangements, boutonnieres, and ceremony florals designed around your vision and color palette.", vi: "Hoa cô dâu, hoa phù dâu, hoa cài áo và hoa lễ cưới được thiết kế theo ý tưởng và bảng màu của bạn." },
    features: { en: ["Bridal bouquet", "Bridesmaid bouquets", "Boutonnieres & corsages", "Ceremony arrangements"], vi: ["Hoa cô dâu", "Hoa phù dâu", "Hoa cài áo", "Hoa lễ cưới"] },
    startingAt: { en: "Starting at $800", vi: "Từ $800" },
  },
  {
    title: { en: "Full Floral Design", vi: "Thiết Kế Hoa Toàn Bộ" },
    description: { en: "Complete floral design for your venue — centerpieces, installations, arches, aisle décor, and everything in between.", vi: "Thiết kế hoa toàn diện cho địa điểm — hoa bàn tiệc, cổng hoa, trang trí lối đi và tất cả mọi thứ." },
    features: { en: ["Centerpieces", "Arch & altar florals", "Aisle décor", "Cocktail hour arrangements"], vi: ["Hoa bàn tiệc", "Cổng hoa & bàn thờ", "Trang trí lối đi", "Hoa tiệc cocktail"] },
...
function Nav({ lang, setLang }) {
  ...
  const links = [
    [t(T.nav.shop, lang), "shop"], [t(T.nav.weddings, lang), "weddings"],
    [t(T.nav.story, lang), "story"], [t(T.nav.contact, lang), "contact"],
  ];
  ...
  return (
    <nav style={{
      ...
      <div style={{ cursor: "pointer", display: "flex", flexDirection: "column", lineHeight: 1.15 }}
        ...
        <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 19, fontWeight: 700, color: "#3D2B1F" }}>
          HH Floral <span style={{ fontWeight: 400, fontStyle: "italic", color: "#A0826D" }}>&</span> Wedding
        </span>
        <span style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 9.5, color: "#A0826D", letterSpacing: "0.18em", textTransform: "uppercase" }}>
          Huân & Hậu · Chicago
        </span>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 28 }} className="nav-desktop">
        {links.map(([label, target]) => (
          <button key={target} onClick={() => scrollTo(target)} style={{
            background: "none", border: "none", fontFamily: "'Be Vietnam Pro', sans-serif",
            fontSize: 12.5, fontWeight: 500, color: "#5C4033", letterSpacing: "0.06em",
        ...
        <div style={{
          ...
          {links.map(([label, target]) => (
            <button key={target} onClick={() => { scrollTo(target); setMenuOpen(false); }} style={{
              background: "none", border: "none", fontFamily: "'Be Vietnam Pro', sans-serif",
              fontSize: 14, fontWeight: 500, color: "#5C4033", letterSpacing: "0.06em",
              textTransform: "uppercase", cursor: "pointer", textAlign: "left", padding: "6px 0",
            }}>{label}</button>
          ))}
        </div>
      )}
...
function Hero() {
  ...
  return (
    <section style={{
      ...
      {/* Background blobs */}
      <div style={{ position: "absolute", top: "8%", left: "-5%", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(232,180,184,0.15) 0%, transparent 70%)", filter: "blur(40px)" }} />
      <div style={{ position: "absolute", bottom: "12%", right: "-8%", width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(180,167,214,0.1) 0%, transparent 70%)", filter: "blur(50px)" }} />

      <div style={{ opacity: loaded ? 1 : 0, transform: loaded ? "translateY(0)" : "translateY(30px)", transition: "all 1s cubic-bezier(0.23,1,0.32,1)", maxWidth: 900, width: "100%" }}>
        <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", color: "#A0826D", marginBottom: 24, fontWeight: 500 }}>{t(T.hero.above, lang)}</p>

        {/* Hero image placeholder */}
        <div style={{ marginBottom: 32, maxWidth: 700, margin: "0 auto 32px" }}>
          <PlaceholderImage
            label="Hero Photo — Your Best Arrangement"
            labelVi="Ảnh Bìa — Bó Hoa Đẹp Nhất"
            height={360}
        ...
        <h1 style={{
          fontFamily: "'Playfair Display', serif", fontSize: "clamp(48px, 8vw, 88px)",
          fontWeight: 700, color: "#3D2B1F", lineHeight: 1.0, marginBottom: 6, letterSpacing: "-0.03em",
        }}>
          Huân <span style={{ fontStyle: "italic", fontWeight: 400, color: "#A0826D" }}> & </span> Hậu
        </h1>

        <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 12, letterSpacing: "0.22em", color: "#B89E8E", marginBottom: 32, textTransform: "uppercase", fontWeight: 500 }}>{t(T.hero.sub, lang)}</p>
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
          <button onClick={() => scrollTo("shop")} style={{
            ...
            background: "#3D2B1F", color: "#FDF9F4", border: "none", cursor: "pointer", transition: "all 0.3s",
          }}
      ...
      <div style={{ position: "absolute", bottom: 32, display: "flex", flexDirection: "column", alignItems: "center", gap: 8, opacity: loaded ? 0.5 : 0, transition: "opacity 1.5s ease 0.8s", animation: "floatUp 2s ease-in-out infinite" }}>
        <span style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "#A0826D" }}>{t(T.hero.scroll, lang)}</span>
  ...
  return (
    <section id="shop" style={{ padding: "100px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 64 }}>
        <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", color: "#A0826D", marginBottom: 16 }}>{t(T.shop.above, lang)}</p>
        ...
        {[1,2,3,4].map((num) => (
          <div key={num} style={{
            ...
            <div style={{
              ...
              fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 13, fontWeight: 600, transition: "all 0.3s",
            }}>{num}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(170px, 1fr))", gap: 16 }}>
            {FLOWERS.map((f) => (
              <button key={f.id} onClick={() => { setSelFlower(f.id); setSelColor(null); setStep(2); }} style={{
                ...
                transition: "all 0.3s", borderRadius: 2, overflow: "hidden",
              }}
              ...
              >
                <div style={{
                  ...
                  <img src={f.image} alt={t(f.name, lang)} style={{
                ...
                <div style={{ padding: "14px 10px 16px" }}>
                  <div style={{
                    ...
                    color: selFlower === f.id ? "#FDF9F4" : "#3D2B1F", marginBottom: 4,
                  }}>{t(f.name, lang)}</div>
                  <div style={{
                  ...
                  <div style={{
                    ...
                    color: selFlower === f.id ? "#C4A87C" : "#3D2B1F", marginTop: 8,
                  }}>from ${f.basePrice}</div>
                </div>
              </button>
            ))}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: 14, maxWidth: 850, margin: "0 auto" }}>
            {SIZES.map((s) => (
              <button key={s.id} onClick={() => { setSelSize(s.id); setStep(4); }} style={{
                ...
                <div style={{ fontSize: 15, marginBottom: 6, letterSpacing: 4, color: selSize === s.id ? "#FDF9F4" : "#A0826D" }}>{s.icon}</div>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 14, flexWrap: "wrap", marginBottom: 48 }}>
            {ADDONS.map((a) => (
              <button key={a.id} onClick={() => toggleAddon(a.id)} style={{
                padding: "14px 22px", background: selAddons.includes(a.id) ? "#FAF5F0" : "#FFFFFF",
                border: selAddons.includes(a.id) ? "1.5px solid #3D2B1F" : "1.5px solid #E8E0D8",
                cursor: "pointer", transition: "all 0.3s", borderRadius: 2, display: "flex", alignItems: "center", gap: 12,
              }}>
                <div style={{
                  width: 20, height: 20, border: selAddons.includes(a.id) ? "1.5px solid #3D2B1F" : "1.5px solid #C4B5A8",
                  background: selAddons.includes(a.id) ? "#3D2B1F" : "transparent",
                  display: "flex", alignItems: "center", justifyContent: "center", color: "#FDF9F4", fontSize: 12, borderRadius: 2,
            ...
            <div style={{ maxWidth: 520, margin: "0 auto", background: "#FFFFFF", border: "1.5px solid #E8E0D8", overflow: "hidden" }}>
              ...
              <div style={{ padding: 32 }}>
                ...
                <button style={{
                  ...
                  fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", cursor: "pointer", transition: "background 0.3s",
                }}
    ...
    <section id="weddings" style={{ padding: "100px 24px", background: "#F5EDE6" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", color: "#A0826D", marginBottom: 16 }}>{t(T.weddings.above, lang)}</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 24 }}>
          {WEDDING_SERVICES.map((svc, i) => (
            ...
            >
              ...
              <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 14, fontWeight: 700, color: "#3D2B1F" }}>{t(svc.startingAt, lang)}</p>
            </div>
          ))}
        </div>
...
function StorySection() {
  ...
  return (
    <section id="story" style={{ padding: "100px 24px", maxWidth: 900, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", color: "#A0826D", marginBottom: 16 }}>{t(T.story.above, lang)}</p>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(32px,5vw,48px)", color: "#3D2B1F", fontWeight: 700, marginBottom: 32 }}>{t(T.story.title, lang)}</h2>
      </div>

      {/* Story layout with photo placeholder */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", marginBottom: 48 }} className="story-grid">
        <PlaceholderImage
          label="Photo of Huân & Hậu"
          labelVi="Ảnh Huân & Hậu"
          height={400}
          style={{ borderRadius: 2 }}
        />
        <div style={{
          fontFamily: "'Lora', serif", fontSize: 15.5, color: "#5C4033", lineHeight: 1.8,
      ...
      <div style={{ textAlign: "center", maxWidth: 650, margin: "0 auto", marginBottom: 48 }}>
        ...
        <p style={{ fontStyle: "italic", color: "#A0826D", fontFamily: "'Playfair Display', serif", fontSize: 20 }}>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20, textAlign: "left" }}>
          <div>
            ...
            <input type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder={t(T.contact.namePh, lang)} style={{
              width: "100%", padding: "14px 16px", background: "rgba(253,249,244,0.08)", border: "1px solid rgba(253,249,244,0.15)",
              color: "#FDF9F4", fontFamily: "'Lora', serif", fontSize: 15, borderRadius: 2, outline: "none", boxSizing: "border-box",
            }} />
          </div>
          <div>
            ...
            <input type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} placeholder="your@email.com" style={{
              width: "100%", padding: "14px 16px", background: "rgba(253,249,244,0.08)", border: "1px solid rgba(253,249,244,0.15)",
              color: "#FDF9F4", fontFamily: "'Lora', serif", fontSize: 15, borderRadius: 2, outline: "none", boxSizing: "border-box",
            }} />
          </div>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              {["bouquet", "wedding", "event", "other"].map((val) => (
                <button key={val} onClick={() => setForm({ ...form, type: val })} style={{
                  padding: "10px 18px", background: form.type === val ? "rgba(253,249,244,0.15)" : "transparent",
          ...
          <div>
            ...
            <textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} placeholder={t(T.contact.messagePh, lang)} rows={5} style={{
              width: "100%", padding: "14px 16px", background: "rgba(253,249,244,0.08)", border: "1px solid rgba(253,249,244,0.15)",
              color: "#FDF9F4", fontFamily: "'Lora', serif", fontSize: 15, borderRadius: 2, outline: "none", resize: "vertical", boxSizing: "border-box",
            }} />
          </div>
          <button onClick={() => alert(lang === "en" ? "Thank you for reaching out! We'll be in touch soon. 🌸" : "Cảm ơn bạn đã liên hệ! Chúng tôi sẽ phản hồi sớm. 🌸")} style={{
            padding: 16, background: "#C4A87C", color: "#3D2B1F", border: "none",
            fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 13, fontWeight: 700,
            letterSpacing: "0.08em", textTransform: "uppercase", cursor: "pointer", transition: "all 0.3s", borderRadius: 2,
          }}
        ...
        <div style={{ marginTop: 64, paddingTop: 32, borderTop: "1px solid rgba(253,249,244,0.1)", display: "flex", flexDirection: "column", gap: 8, alignItems: "center" }}>
